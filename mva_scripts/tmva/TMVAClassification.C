...
//cout << "hello hello " << endl;
   ...
   factory->AddVariable( "Bplus_ETA",                "Bplus_ETA", "", 'F' );
   factory->AddVariable( "Bplus_P",                "Bplus_P", "", 'F' );

   // You can add so-called "Spectator variables", which are not used in the MVA training,
   // but will appear in the final "TestTree" produced by TMVA. This TestTree will contain the
   // input variables, the response values of all trained MVAs, and the spectator variables
   factory->AddSpectator( "Bplus_PT",  "Bplus_PT", "units", 'F' );


   // Read training and test data
   // (it is also possible to use ASCII format as input -> see TMVA Users Guide)
   TString fname_signal =   "/afs/cern.ch/user/y/yamhis/BAE/bae-mc-12215002-2012-down.root";
   TString fname_background ="/afs/cern.ch/user/y/yamhis/BAE/bae-mc-12215002-2012-down.root";
   ...
   TTree *signal     = (TTree*)input_signal->Get("bar-muon-tuple/DecayTree");
   TTree *background = (TTree*)input_background->Get("bae-muon-tuple/DecayTree");
